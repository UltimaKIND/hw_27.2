    ...
    def handle(self, *args, **kwargs):
        ...
        if selected_lesson:
            Payment.objects.create(
                user=user, lesson=selected_lesson, payment_amount=payment_amount, payment=payment
            )
        elif selected_course:
            Payment.objects.create(
                user=user, course=selected_course, payment_amount=payment_amount, payment=payment
            )
